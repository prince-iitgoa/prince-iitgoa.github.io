...
\resumeSubHeadingListStart
    ...
    \resumeProject
      ...
      {A web application to manage employee profiles of Tata Elxsi.} %Project Name, Location Name
    ...
    \vspace{-2mm}
     \resumeProject
      ...
      {Developed a Continuous Cellular Automata based fuzzy classifier in Java using Weka.} %Project Name, Location Name
...
\section{{\footnotesize \faBook}\textbf{ Publications}}
 \resumeSubHeadingListStart
      \resumeSubheading
      {One deterministic-counter Automata}{arXiv}
      {Co-authors: Dr.~Vincent Penelle, Dr.~Prakash Saivasan, Dr.~Sreejith A.V.}{January 31, 2023}
      \vspace{-2.0mm}
       \resumeSubheading
      {CAP: A Cellular Automata based fuzzy classifier}{Materials Today Proceedings}
      {Co-authors: Dr.~Abdul Nizar M}{February 26, 2022}
      \vspace{-2.0mm} 
         \resumeSubheading
      {Optical music recognition using image processing and machine learning}{IJCSE}
 ...
 \section{{\footnotesize \faUniversity}\textbf{ Research Visits}}
  \resumeSubHeadingListStart
      \resumePoint
      {The Institute of Mathematical Sciences, HBNI}{June 1-30, 2022}
      \vspace{-2.0mm}
 \resumeSubHeadingListEnd
